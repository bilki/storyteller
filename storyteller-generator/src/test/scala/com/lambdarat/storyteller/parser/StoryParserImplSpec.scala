...
class StoryParserImplSpec extends AnyFlatSpec with Matchers {
  ...
  "Step parser" should "parse given step" in {
    ...
    val parsed   = StoryParserImpl.step.parseOnly(stepText).either
  ...
  "Steps parser" should "parse single step" in {
    ...
    val parsed    = StoryParserImpl.steps.parseOnly(storyText).either
